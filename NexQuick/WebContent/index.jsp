...
(function()
		{
		    ...
		    {
//		        this.host = host;
		        this.host = '${pageContext.request.contextPath}';
		        this.botId = botId;
...
//		                style.setAttribute('href', '${pageContext.request.contextPath}/js/playchat-web/playchat-web.css');

		                var script = document.createElement('script');
		                script.type = 'text/javascript';

		                script.src = this.host + '/js/playchat-web/playchat-web-core.js';
//		                script.src = '${pageContext.request.contextPath}/js/playchat-web/playchat-web-core.js';
