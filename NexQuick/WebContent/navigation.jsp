...
<html lang="en" class="no-js">
	...
	<body>
		...
		<ul id="gn-menu" class="gn-menu-main mb-5" style = "z-index: 9999;">
						...
						<ul class="gn-menu">
							...
							<li>
								...
								<ul class="gn-submenu">
									...
									<% if(csInfo.getCsGrade() == 2) { %>
										<li><a href = "<%= request.getContextPath() %>/csPage/businessPage.jsp"><i class="fas fa-building navIcons"></i>법인 관리</a></li>
									<% } %>
			...
			<li><a id = "logo" href="<%= request.getContextPath() %>/mainPage/main_index.jsp"><img src = "<%= request.getContextPath() %>/image/index_img/NexQuick_logo_white_mic_5.png" height = "40" width = "250" style = "margin-top: 10px;"/></a></li>
