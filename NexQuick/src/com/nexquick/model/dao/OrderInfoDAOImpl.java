...
//	0614 김민규 추가
	...
	@Override
	public List<OnDelivery> selectQPCallByIdAndDate(HashMap<String, Object> condition) {
		return sqlSession.selectList("orderInfo.selectQPCallByIdAndDate", condition);
	}
}
