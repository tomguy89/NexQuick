...
public class OrderListActivity2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
//            this.items = object2;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_new_order) {
            ...
            Intent intent = new Intent(getApplicationContext(), OrderListActivity2.class);
            startActivity(intent);
