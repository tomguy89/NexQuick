...
public class fragment_order_list extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fragment_order_list.CustomAdapter insuAdapter = new fragment_order_list.CustomAdapter(getActivity(), 0, insuList);
        fragment_order_list.CustomAdapter indoAdapter = new fragment_order_list.CustomAdapter(getActivity(), 0, indoList);
